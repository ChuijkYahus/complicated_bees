...
/**
 * An interface for games for the microscope - these games have four states (see {@link MicroscopeGamePacketClientbound.GameState}), which determine how the game will proceed.
 *
 */
public interface IMicroscopeGame {
    /**
     * Sends a guess against a sequence held by the server - will receive a packet that calls {@link #setGameState(MicroscopeGamePacketClientbound.GameState)}.
