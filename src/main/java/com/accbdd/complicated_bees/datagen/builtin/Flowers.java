...
public class Flowers {
    ...
    public static final Map.Entry<ResourceKey<Flower>, Flower> ICY = flower("icy", List.of(Blocks.ICE, Blocks.BLUE_ICE, Blocks.PACKED_ICE), List.of());
    ...
    public static final Map.Entry<ResourceKey<Flower>, Flower> MYCELIC = flower("mycelic", List.of(Blocks.MUSHROOM_STEM, Blocks.RED_MUSHROOM, Blocks.BROWN_MUSHROOM, Blocks.BROWN_MUSHROOM_BLOCK, Blocks.RED_MUSHROOM_BLOCK, Blocks.MYCELIUM), List.of());
    ...
    public static final Map.Entry<ResourceKey<Flower>, Flower> SWAMP = flower("swamp", List.of(Blocks.LILY_PAD, Blocks.BROWN_MUSHROOM, Blocks.RED_MUSHROOM, Blocks.VINE), List.of());
