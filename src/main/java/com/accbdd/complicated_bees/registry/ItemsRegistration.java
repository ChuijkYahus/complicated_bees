...
public class ItemsRegistration {
    ...
    public static final RegistryObject<Item> GYROFUGE_BASIC_PROCESSING_UNIT = register("gyrofuge_basic_processing_unit", () -> new GyrofugeUpgradeBlockItem(BlocksRegistration.GYROFUGE_BASIC_PROCESSING_UNIT.get()));
    public static final RegistryObject<Item> GYROFUGE_PROCESSING_UNIT = register("gyrofuge_processing_unit", () -> new GyrofugeUpgradeBlockItem(BlocksRegistration.GYROFUGE_PROCESSING_UNIT.get()));
    public static final RegistryObject<Item> GYROFUGE_ADVANCED_PROCESSING_UNIT = register("gyrofuge_advanced_processing_unit", () -> new GyrofugeUpgradeBlockItem(BlocksRegistration.GYROFUGE_ADVANCED_PROCESSING_UNIT.get()));
    ...
    public static final RegistryObject<Item> GYROFUGE_BASIC_SPEED_UNIT = register("gyrofuge_basic_speed_unit", () -> new GyrofugeUpgradeBlockItem(BlocksRegistration.GYROFUGE_BASIC_SPEED_UNIT.get()));
    public static final RegistryObject<Item> GYROFUGE_SPEED_UNIT = register("gyrofuge_speed_unit", () -> new GyrofugeUpgradeBlockItem(BlocksRegistration.GYROFUGE_SPEED_UNIT.get()));
    public static final RegistryObject<Item> GYROFUGE_ADVANCED_SPEED_UNIT = register("gyrofuge_advanced_speed_unit", () -> new GyrofugeUpgradeBlockItem(BlocksRegistration.GYROFUGE_ADVANCED_SPEED_UNIT.get()));
    public static final RegistryObject<Item> GYROFUGE_BASIC_EFFICIENCY_UNIT = register("gyrofuge_basic_efficiency_unit", () -> new GyrofugeUpgradeBlockItem(BlocksRegistration.GYROFUGE_BASIC_EFFICIENCY_UNIT.get()));
    public static final RegistryObject<Item> GYROFUGE_EFFICIENCY_UNIT = register("gyrofuge_efficiency_unit", () -> new GyrofugeUpgradeBlockItem(BlocksRegistration.GYROFUGE_EFFICIENCY_UNIT.get()));
    public static final RegistryObject<Item> GYROFUGE_ADVANCED_EFFICIENCY_UNIT = register("gyrofuge_advanced_efficiency_unit", () -> new GyrofugeUpgradeBlockItem(BlocksRegistration.GYROFUGE_ADVANCED_EFFICIENCY_UNIT.get()));
    public static final RegistryObject<Item> GYROFUGE_BASIC_EXTRACTION_UNIT = register("gyrofuge_basic_extraction_unit", () -> new GyrofugeUpgradeBlockItem(BlocksRegistration.GYROFUGE_BASIC_EXTRACTION_UNIT.get()));
    public static final RegistryObject<Item> GYROFUGE_EXTRACTION_UNIT = register("gyrofuge_extraction_unit", () -> new GyrofugeUpgradeBlockItem(BlocksRegistration.GYROFUGE_EXTRACTION_UNIT.get()));
    public static final RegistryObject<Item> GYROFUGE_ADVANCED_EXTRACTION_UNIT = register("gyrofuge_advanced_extraction_unit", () -> new GyrofugeUpgradeBlockItem(BlocksRegistration.GYROFUGE_ADVANCED_EXTRACTION_UNIT.get()));
