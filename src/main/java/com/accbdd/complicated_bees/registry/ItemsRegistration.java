...
public class ItemsRegistration {
    ...
    public static final RegistryObject<Item> BASIC_UPGRADE = register("basic_upgrade", () -> new UpgradeItem(new Item.Properties(), new MachineModifier(1.1f, 1.1f, 1f, 1)));
    public static final RegistryObject<Item> WAXED_UPGRADE = register("waxed_upgrade", () -> new UpgradeItem(new Item.Properties(), new MachineModifier(1f, 1.25f, 1f, 1)));
    public static final RegistryObject<Item> HONEYED_UPGRADE = register("honeyed_upgrade", () -> new UpgradeItem(new Item.Properties(), new MachineModifier(1.25f, 1f, 1f, 1)));
    public static final RegistryObject<Item> TWISTED_UPGRADE = register("twisted_upgrade", () -> new UpgradeItem(new Item.Properties(), new MachineModifier(2f, 0.85f, 1f, 1)));
    public static final RegistryObject<Item> SILKY_UPGRADE = register("silky_upgrade", () -> new UpgradeItem(new Item.Properties(), new MachineModifier(0.85f, 2f, 1f, 1)));
    public static final RegistryObject<Item> ROYAL_UPGRADE = register("royal_upgrade", () -> new UpgradeItem(new Item.Properties(), new MachineModifier(1.5f, 1.5f, 1f, 1)));
    public static final RegistryObject<Item> ENDENIC_UPGRADE = register("endenic_upgrade", () -> new UpgradeItem(new Item.Properties().rarity(Rarity.UNCOMMON), new MachineModifier(0.5f, 4f, 1f, 1)));
    public static final RegistryObject<Item> WITHERED_UPGRADE = register("withered_upgrade", () -> new UpgradeItem(new Item.Properties().rarity(Rarity.UNCOMMON), new MachineModifier(4f, 0.5f, 1f, 1)));
