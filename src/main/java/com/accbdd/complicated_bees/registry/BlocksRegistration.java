...
public class BlocksRegistration {
    ...
    public static final RegistryObject<MellariumBlock> MELLARIUM_FRAME = BLOCKS.register("mellarium_frame_housing", () -> new MellariumBlock(MellariumBlock.MellariumBlockType.FRAME));
