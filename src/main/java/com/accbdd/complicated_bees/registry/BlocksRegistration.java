...
public class BlocksRegistration {
    ...
    public static final RegistryObject<MellariumDirectionalBlock> MELLARIUM_FAN = BLOCKS.register("mellarium_fan", MellariumDirectionalBlock::new);
    public static final RegistryObject<MellariumDirectionalBlock> MELLARIUM_FRAME_HOUSING_1 = BLOCKS.register("mellarium_frame_housing_1", () -> new MellariumFrameHousingBlock(1));
    public static final RegistryObject<MellariumDirectionalBlock> MELLARIUM_FRAME_HOUSING_2 = BLOCKS.register("mellarium_frame_housing_2", () -> new MellariumFrameHousingBlock(2));
    public static final RegistryObject<MellariumDirectionalBlock> MELLARIUM_FRAME_HOUSING_3 = BLOCKS.register("mellarium_frame_housing_3", () -> new MellariumFrameHousingBlock(3));
