...
public class BlocksRegistration {
    ...
    public static final RegistryObject<MellariumBlock> MELLARIUM_ENERGY_ACCEPTOR = BLOCKS.register("mellarium_energy_acceptor", MellariumEnergyAcceptorBlock::new);
